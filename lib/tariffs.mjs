export const CONSULTATION_TARIFFS = Object.freeze([
  Object.freeze({ code: "situation-check", name: "Проверка ситуации", description: "Персональная проверка НДФЛ, возникает ли обязанность подать 3-НДФЛ, возможные способы законно уменьшить налог или получить возврат", amountKopecks: 39000, deadlineMinutes: 240, recommended: true }),
  Object.freeze({ code: "detailed-review", name: "Расчёт и подробный разбор", description: "Расчет налога или возврата, нормативные основания и подробные рекомендации по вашему вопросу", amountKopecks: 99000, deadlineMinutes: 480 }),
]);
