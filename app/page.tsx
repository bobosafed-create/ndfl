    ...
    <main>
      ...
      <section className="qa-section" aria-labelledby="qa-heading">
        ...
        <div className="qa-list">
          ...
          <details>
            <summary><span>04</span>Входит ли в консультацию дополнительный уточняющий вопрос?</summary>
            <div className="qa-answer"><p>Нет. Оплата включает один первоначальный вопрос и один письменный ответ консультанта. Дополнительный или уточняющий вопрос оформляется как новая консультация.</p></div>
          </details>
          <details>
            <summary><span>05</span>Что произойдёт, если для точного вывода недостаточно данных?</summary>
            <div className="qa-answer"><p>Консультант подготовит ответ в пределах предоставленных сведений и отметит это в конце текста. Если дополнительные обезличенные сведения могут повлиять на вывод, их следует изложить в новом вопросе, оформленном в том же порядке, что и первоначальный.</p></div>
          </details>
        </div>
